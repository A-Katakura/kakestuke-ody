<html lang="ja">
    <head>
        <!-- Google Tag Manager --> 
        <script async="" src="https://www.googletagmanager.com/gtm.js?id=GTM-P6MHFN25"></script><script>(function(w,d,s,l,i){w[l]=w[l]||[];w[l].push({'gtm.start':
            new Date().getTime(),event:'gtm.js'});var f=d.getElementsByTagName(s)[0],
            j=d.createElement(s),dl=l!='dataLayer'?'&l='+l:'';j.async=true;j.src=
            'https://www.googletagmanager.com/gtm.js?id='+i+dl;f.parentNode.insertBefore(j,f);
            })(window,document,'script','dataLayer','GTM-P6MHFN25');</script> 
        ...
        <!--SNS-->
        <meta property="og:title" content="駆けつけ救急車">
        <!--タイトル-->
        <meta property="og:type" content="website">
        <!--サイトの種類-->
        <meta property="og:description" content="駆けつけ救急車">
        <meta property="og:url" content="ページのURL">
        <meta property="og:site_name" content="駆けつけ救急車">
...
<body monica-id="ofpnmcalabcbjgholdjcjblkibolbppb" monica-version="7.9.1">
    ...
    <div class="wrapper">
        <div class=wrapper--main> 
            ...
            <div class="cta-area sp-img"> <a href="tel:0120-734-835"> <img class="btn-img" src="<?php echo get_template_directory_uri(); ?>/img/tellbtn.png"> </a> <img class="sp-img" src="<?php echo get_template_directory_uri(); ?>/img/car_04.jpg"> </div>
            <div class="cta-area sp-img"> <a href="https://page.line.me/935vuwbe"> <img class="btn-img" src="<?php echo get_template_directory_uri(); ?>/img/linebtn.png"> </a> <img class="sp-img" src="<?php echo get_template_directory_uri(); ?>/img/car_05.jpg"> </div>
            ...
            <footer class=footer> 
                ...
                <div class="footer--Copyright">
                    <div class="tokupura"> <a href="https://kaketsuke99.com/form/lp/privacy-policy/">プライバシーポリシー</a> <a href="https://kaketsuke99.com/form/lp/specifiedcommercialtransactionlaw/">特定商取引法について</a> </div>
                    <p>©Copyright 2022</p>
                </div>
            </footer>
            <div class="footer--fix-btn">
                <div class="fixed_ttl"><img src="<?php echo get_template_directory_uri(); ?>/img/fixed_copy.png" alt="↓web限定キャンペーン実施中↓"></div>   <ul>
                <li class="nickname_button"> <a href="https://page.line.me/935vuwbe"><img src="<?php echo get_template_directory_uri(); ?>/img/fixed_linebtn.png"></a> </li>
                <li class="mypage_button"> <a href="tel:0120-734-835"><img src="<?php echo get_template_directory_uri(); ?>/img/fixed_tellbtn.png"></a> </li>   </ul>
            </div>
        </div>
    </div>
